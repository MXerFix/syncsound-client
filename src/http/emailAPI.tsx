  ...
  const EmailHTML = () => {
    return (
      <div>
        ...
        <p> Способ оплаты: {emailHTMLData.payment} </p>
...
export const send_offer_to_user = async (emailData: EmailDataType, emailHTMLData: { offer_id: string, name: string, devices: any[], sum: number, payment: string, pvzAddress: string  }) => {
